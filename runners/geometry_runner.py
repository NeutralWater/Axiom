...
def run_geometry():
    ...
    #3d volumes
        ...
        show_formula(formula_display.sphere_volume())
        print("")
        ...
        show_formula(formula_display.cylinder_volume())
        print("")
        ...
        show_formula(formula_display.cone_volume())
        print("")
        ...
        show_formula(formula_display.prism_volume())
        print("")
        ...
        show_formula(formula_display.pyramid_volume())
        print("")
        ...
        show_formula(formula_display.torus_volume())
        print("")
        ...
        show_formula(formula_display.ellipsoid_volume())
        print("")
        ...
        show_formula(formula_display.frustum_volume())
        print("")
    ...
    #3d surface area
        ...
        show_formula(formula_display.sphere_surface_area())
        print("")
        ...
        show_formula(formula_display.cylinder_surface_area())
        print("")
        ...
        show_formula(formula_display.cone_surface_area())
        print("")
    elif choice == "18":
        ...
        show_formula(formula_display.prism_surface_area())
        print("")
        ...
        show_formula(formula_display.pyramid_surface_area())
        print("")
        ...
        show_formula(formula_display.torus_surface_area())
        print("")
        ...
        show_formula(formula_display.ellipsoid_surface_area())
        print("")
        ...
        show_formula(formula_display.frustum_surface_area())
        print("")
